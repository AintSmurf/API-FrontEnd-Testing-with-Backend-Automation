...
class TestEndToEndGuestUser():
    ...
    def test_end_to_end_checkout_guest_user(self):
        ...
        #apply free coupon
        cart_page.apply_discount(os.environ.get('COUPON'))
        ...
        checkout_page.fill_the_form(generate_random_username(), "snow", "St. Robert", "Alabama", "10573", "041111111111", temp_email)
        ...
        assert text == message, f"Expected text is {message}" \
                                                           f"but we got instead {text}"
